...
function getItem(level) {
  ...
  return ITEMS[level - 1] || EMPTY_ITEM;
    ...
    // Sidebar donation button (map-only, always shown regardless of
    // ads-removed/Premium status — see .remove-ads-card CSS). It's
